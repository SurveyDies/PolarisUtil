...
class Info(commands.Cog):
    ...
    @app_commands.command(name="info", description="Displays bot information and statistics with a bit of flair!")
    async def info_command(self, ctx):
        ...
        embed.add_field(name="📅 Version", value="0.2.2", inline=False)
        ...
        embed.add_field(name="🌐 Guilds I'm in", value=len(self.bot.guilds), inline=False)
        embed.add_field(name="👥 Users I'm serving", value=len(set(self.bot.get_all_members())), inline=False)
        embed.add_field(name="💻 GitHub", value="[Check out my code on GitHub!](https://github.com/yourusername/yourbotrepo)", inline=False)
